    ...
    public function participantCertificate($part_id, $course_id)
    {
        try {
            ...
            <table class="table" width="100%">
                <tr>
                    <td style="text-align:center; width: 2%; text-align: center; background-color: transparent;"></td>
                    <td style="align:left; width: 32%; text-align: center; background-color: transparent;">
                        <img src="' . public_path('assets/images/bida_logo.png') . '" style="float:left; width: 80px;" />
                    </td>
                    <td style="text-align:center; width: 32%; text-align: center; background-color: transparent;">
                        <img src="' . public_path('assets/images/bida_logo_v2.jpg') . '" style="float:center; width: 40px;" />
                    </td>
                    <td style="text-align:right; width: 32%; text-align: center; background-color: transparent;">
