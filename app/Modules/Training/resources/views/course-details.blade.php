                    ...
                    <div class="modalContent">
                        <div class="form-group row">
                            <div class="col-md-6 row">
                                {!! Form::label('course_name', 'Training Name', ['class' => 'col-md-4 col-form-label']) !!}
                                <div class="col-md-8">
                            ...
                            <div class="col-md-6 row">
                                {!! Form::label('course_location', 'Training Location', ['class' => 'col-md-4 col-form-label']) !!}
                                <div class="col-md-8">
                                    {!! Form::text('course_location', $course->venue, [
                                        'class' => 'form-control',
                                        'id' => 'course_location',
                                        'readonly' => 'readonly',
                                    ]) !!}
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 row">
                                {!! Form::label('course_fee', 'Training Fee', ['class' => 'col-md-4 col-form-label']) !!}
                                <div class="col-md-8">
                            ...
                            <div class="col-md-6 row">
                                ...
                                <div class="col-md-8">
                                    {!! Form::text('name', Auth::user()->user_first_name ?? Auth::user()->user_first_name.' '.Auth::user()->user_middle_name ?? Auth::user()->user_middle_name.' '.Auth::user()->user_last_name ?? Auth::user()->user_last_name, [
                                        'class' => 'form-control',
                                        'id' => 'name',
                                        'readonly' => 'readonly',
                                    ]) !!}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6 row">
                                ...
                                <div class="col-md-8">
                                    {!! Form::select('profession', ['job_holder' => 'Job Holder', 'student' => 'Student'], null, [
                                        'class' => 'form-control required input-md',
                                        'id' => 'profession', 'onchange' => 'professionChange(this.value)',
                                    ]) !!}
                        ...
                        <div class="form-group row d-none" id="studentDiv">
                            <div class="col-md-6 row">
                                {!! Form::label('ins_name', 'Institute Name', ['class' => 'col-md-4 col-form-label required-star']) !!}
                                <div class="col-md-8">
                                    {!! Form::text('ins_name', null, ['class' => 'form-control', 'id' => 'ins_name']) !!}
                                    {!! $errors->first('ins_name', '<span class="help-block">:message</span>') !!}
                                </div>
                            </div>
                            <div class="col-md-6 row" id="designationDiv">
                                {!! Form::label('last_qualification', 'Academic Qualification (Latest)', ['class' => 'col-md-4 col-form-label required-star']) !!}
                                <div class="col-md-8">
                                    {!! Form::text('last_qualification', null, ['class' => 'form-control', 'id' => 'last_qualification']) !!}
                                    {!! $errors->first('last_qualification', '<span class="help-block">:message</span>') !!}
                                </div>
                            </div>
                        ...
                        <div class="form-goup row">
                            <div class="col-md-6 row" id="designationDiv">
                                {!! Form::label('attachment_type', 'Attachment Type', ['class' => 'col-md-4 col-form-label']) !!}
                                <div class="col-md-8">
                                    {!! Form::text('attachment_type', null, ['class' => 'form-control', 'id' => 'attachment_type']) !!}
                                    {!! $errors->first('attachment_type', '<span class="help-block">:message</span>') !!}
                                </div>
                            </div>
                            <div class="col-md-6 row">
...
@section('footer-script')
    ...
    <script>
        ...
        function professionChange(value) {
            if (value == 'job_holder') {
                $('#jobHolderDiv').removeClass('d-none');
