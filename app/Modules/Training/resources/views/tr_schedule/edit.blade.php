                ...
                <div class="card-body row">
                    ...
                    <div class="col-md-6 form-group row">
                        ...
                        <div class="col-md-8 {{ $errors->has('district_id') ? 'has-error' : '' }}">
                            {!! Form::select('district_id', $districts, $tr_data->district_id, [
                                'class' => 'form-control required imput-md',
                                'id' => 'district_id',
                    ...
                    <div class="col-md-6 form-group row">
                        ...
                        <div class="col-md-8 {{ $errors->has('thana_id') ? 'has-error' : '' }}">
                            {!! Form::select('thana_id', ['' => 'Select Thana/Upzilla'], $tr_data->thana_id, [
                    ...
                    <div class="col-md-6 form-group row">
                        ...
                        <div class="col-md-8  {{ $errors->has('no_of_batch') ? 'has-error' : '' }}">
                            {!! Form::text('no_of_batch', $tr_data->no_of_batch, [
                                'class' => 'form-control input-md required input_ban onlyNumber engOnly',
                                'id' => 'no_of_batch',
                    ...
                    <div class="col-md-6 mt-10 form-group row">
                        ...
                        <div class="col-md-8 {{ $errors->has('expect_start') ? 'has-error' : '' }}">
                            <div class="input-group date datepicker dob_datepicker" id="expect_start"
                                data-target-input="nearest">
                                {!! Form::text('expect_start', $tr_data->expect_start, [
                                    'class' => 'form-control calendarIcon required',
                                    'id' => 'expect_start',
                                ]) !!}
                                            ...
                                            <tr id="courseDetailRow{{ $key }}" data-number="{{ $key }}">
                                                ...
                                                <td>
                                                    {!! Form::text("seat_capacity[$key]", $scheduleData->seat_capacity, [
                                                        'class' => 'form-control input-md input_ban seat_capacity text-center required',
                                                        'placeholder' => '0000',
                                                    ]) !!}
                                                </td>
                                                <td>
                                                    {!! Form::select("speaker_id[$key]", $speakers, $scheduleData->speaker_id, [
                    ...
                    <div class="col-md-12 form-group row">
                        ...
                        <div
                            ...
                            {!! Form::textarea('necessary_qualification_experience', $tr_data->necessary_qualification_experience, [
                                ...
                                'placeholder' => 'Qualifications and Experiences',
                    ...
                    <div class="form-group col-md-12 row">
                        ...
                        <div class="col-md-4">
                            <img src="{{ asset('/uploads/training/thumbnails/' . $tr_data->course_thumbnail_path) }}"
                    ...
                    <div class="col-md-6 form-group row">
                        {!! Form::label('status', 'Training Status: ', ['class' => 'col-md-4 required-star']) !!}
                        <div class="col-md-8 {{ $errors->has('status') ? 'has-error' : '' }}">
                            {!! Form::select('status', ['' => 'Select One', 'upcoming' => 'UpComing', 'ongoing' => 'Ongoing', 'completed'=>'Completed'], $tr_data->status, [
                                'class' => 'form-control required imput-md',
                                'id' => 'status',
                            ]) !!}
                    ...
                    <div class="col-md-6 form-group row">
                        {!! Form::label('is_publish', 'Is Publish: ', ['class' => 'col-md-4 required-star']) !!}
                        <div class="col-md-8 {{ $errors->has('is_publish') ? 'has-error' : '' }}">
                            {!! Form::select('is_publish', ['' => 'Select One', '0' => 'Unpublish', '1' => 'Publish'], $tr_data->is_publish, [
                                'class' => 'form-control required imput-md',
                                'id' => 'is_publish',
                            ]) !!}

                            {!! $errors->first('is_publish', '<span class="help-block">:message</span>') !!}
                        </div>
                    </div>                        
                    @endif
...
@section('footer-script')
    ...
    for (var i = 0; i < attrSel.length; i++) {
        ...
        var repText = nameAtt.replace(/\[\d+\]/, '[' + nameRo + ']');
        var ret = selectId.replace(/_\d+/, '');
    ...
    // Get hidden input elements and update names
    var attrHidden = $("#" + tableID).find('#' + idText).find('input[type=hidden]');
    for (var i = 0; i < attrHidden.length; i++) {
        var nameAtt = attrHidden[i].name;
        var repText = nameAtt.replace(/\[\d+\]/, '[' + nameRo + ']');
        attrHidden[i].name = repText;
        attrHidden[i].value = ''; // Clear the value for the new row
    }
    ...
    $("#" + tableID).find('#' + idText).find('.timepicker').each(function() {
        ...
        var newId = timepickerId.replace(/_\d+/, '_' + rowCoo);
        $(this).attr('id', newId);
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data, function(key, value) {
                        if (value.id == thana_id) {
                            $thanaSelect.append('<option value="' + value.id +
