        ...
        <div class="help_widget">
            ...
            <div class="row" style="padding: 5px 15px">
                <span class="col-md-12 text-left">
                    <button class="btn btn-success btn-xs" style="border-radius: 50%; height: 25px; width: 25px;">
                        <i class="fa fa-calendar" style="
                        display: flex;
                        justify-content: center;"></i>
                    </button>
                    <span class="input_ban" style="font-size: 16px">Duration:
                        {{ date('d F Y', strtotime($row->course_duration_start)) }} -
                        {{ date('d F Y', strtotime($row->course_duration_end)) }}
                    </span>
                </span>
                ...
                <div class="row footerElement">
                    ...
                    <div class="pull-right">
                        <a href="{{ url('web/training-details/' . \App\Libraries\Encryption::encodeId($row->id)) }}"
                            ...
                            style="font-size: 13px"> Details </a>
                    </div>
                </div>
            </div>
