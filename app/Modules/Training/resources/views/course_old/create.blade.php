        ...
        <div class="col-lg-12">
            <div class="card card-magenta border border-magenta">
                <div class="card-header" style="margin-top: -1px;">
                    <h5><strong> Create Training Course </strong></h5>
                </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6 row">
                            ...
                            <div class="col-md-8 {{ $errors->has('training_category') ? 'has-error' : '' }}">
                                {!! Form::select('training_category', ['in-house' => 'In House', 'project' => 'Project'], null, [
                                    'class' => 'form-control required imput-md',
                    ...
                    <div id="projectDiv" class="row hidden">
                        ...
                        <div class="col-md-6 row form-group">
                            ...
                            <div class="col-md-8 {{ $errors->has('project_vendor') ? 'has-error' : '' }}">
                                {!! Form::text('project_vendor', null, ['class' => 'form-control input-md required']) !!}
                        ...
                        <div class="col-md-6 row form-group">
                            ...
                            <div class="col-md-8 {{ $errors->has('package_no') ? 'has-error' : '' }}">
                                {!! Form::text('package_no', null, ['class' => 'form-control input-md required']) !!}
                        ...
                        <div class="col-md-6 row form-group">
                            ...
                            <div class="col-md-8 {{ $errors->has('lot_no') ? 'has-error' : '' }}">
                                {!! Form::text('lot_no', null, ['class' => 'form-control input-md required']) !!}
                    ...
                    <div class="col-md-6 row form-group">
                        ...
                        <div class="col-md-8 {{ $errors->has('training_authority') ? 'has-error' : '' }}">
                            {!! Form::text('training_authority', null, ['class' => 'form-control input-md required']) !!}
                    ...
                    <div class="col-md-6 row form-group">
                        ...
                        <div class="col-md-8 {{ $errors->has('source_of_fund') ? 'has-error' : '' }}">
                            {!! Form::text('source_of_fund', null, ['class' => 'form-control input-md required']) !!}
                    ...
                    <div class="col-md-6 row form-group">
                        ...
                        <div class="col-md-8 {{ $errors->has('fund_amount') ? 'has-error' : '' }}">
                            {!! Form::text('fund_amount', null, ['class' => 'form-control input-md required']) !!}
                    ...
                    <div class="col-md-6 row form-group">
                        ...
                        <div class="col-md-8 {{ $errors->has('training_coordinator') ? 'has-error' : '' }}">
                            {!! Form::select('training_coordinator', trainingCoordinatorList(), null, [
                                'class' => 'form-control required imput-md',
                    ...
                    <div class="col-md-6 row form-group">
                        ...
                        <div class="col-md-8 {{ $errors->has('fund_amount') ? 'has-error' : '' }}">
                            {!! Form::text('training_location', null, ['class' => 'form-control input-md required']) !!}
                    ...
                    <div class="form-group col-md-12 row pr-md-3">
                        {!! Form::label('course_description', 'Course Description', ['class' => 'col-md-2 required-star']) !!}
                        <div class="col-md-10 pr-md-4 {{ $errors->has('course_description') ? 'has-error' : '' }}">
                    ...
                    <div class="form-group col-md-12 row">
                        ...
                        <div class="col-md-6  {{ $errors->has('course_image') ? 'has-error' : '' }}">
                            ...
                            <small class="text-danger">[N.B.: Only jpg, jpeg, png type image supported and image size must
                                be less then 2MB]</small>
