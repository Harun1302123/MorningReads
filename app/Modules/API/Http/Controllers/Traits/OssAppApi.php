...
namespace App\Modules\API\Http\Controllers\Traits;
...
trait OssAppApi
{
 ...
 GROUP  BY report_id  ');
        if (count($allReports) > 0) {
            ...
            //ob#code@start - Harun - undefined encode method
            return $reportResult;
        }
        return null;
    }
    ...
    public function ossPidUserExits($regKey, $userName, $deviceId, $version)
    {
        ...
        $url = config('osspid.osspid_base_url') . "/osspid/api?param=$encodedOssPidRequestData";
