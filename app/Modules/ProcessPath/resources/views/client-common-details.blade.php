            ...
            <div class="card" style="border-radius: 10px;">
                ...
                <div class="card-body" style="padding-bottom: 50px">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 text-center" style="border-left: 1px solid #DFDFDF">
                            ...
                            @foreach($ProcessTypeData as $key=>$item)
                                ...
                                <span style="padding: 8px;; border: 1px solid  #452A73;margin-right: 15px; font-size: 20px;">
                                    <label class="checkbox-inline" style="width: 30%;">{{$item->name_bn}}
                                        <?php
                                        $class = 'other';
                            ...
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    <a href="/client/process/list" class="btn btn-default" style="width:80px;  margin-right: 15px">বাতিল</a>
                                    <a href="javascript:void(0)" onclick="nextMethod()" class="btn btn-primary" style="width:90px;background: #0084FF">পরবর্তী</a>
                                </div>
                            </div>
                        </div>
                    </div>
