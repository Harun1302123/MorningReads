    ...
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-2 ">
                ...
                {!! Form::select('ProcessType', ['' => 'নির্বাচন করুন'] + $ProcessType, '', [
            ...
            @if (!empty($search_by_keyword))
                ...
                @if (count($search_by_keyword_str) > 1)
                    ...
                    <div class="col-md-3">
                        <label for="search_text">{!! trans('ProcessPath::messages.search_text') !!}:
                            <i class="fa fa-info-circle" aria-hidden="true"
                               data-placement="right" data-toggle="tooltip" title=""
                               data-original-title="Only the application's tracking number and reference data will be searched by the keyword you provided.">
                            </i>
                        </label>
                        {!! Form::text('search_text', '', ['class' => 'form-control search_text','placeholder' => 'Type at least 3 characters']) !!}
                    </div>
                @else
                    {{-- for global search --}}
                    <div class="col-md-3">
                        ...
                        {!! Form::text('search_text', !empty($search_by_keyword) ? $search_by_keyword : '', ['class' => 'form-control search_text', 'placeholder' => 'Type at least 3 characters']) !!}
                    </div>
                @endif
            @else
                {{-- for global search --}}
