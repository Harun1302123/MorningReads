...
class ProcessList extends Model
{
    ...
    //ob#code@start - (Galib) This boot method can be common for every model. Now it is written in all models.
    ...
    //ob#code@start - (galib) function scopeSearch() is already declared in ProcessListController and this is unused
    //ob#code@start - Harun this method using $query->search($request) here
