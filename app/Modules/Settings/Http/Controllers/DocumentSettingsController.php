<?php
//ob#code@start - (galib) this controller is being used for document name crud and service do crud. Two separate controller should be used
...
class DocumentSettingsController
{
    ...
    {
        //ob#code@start - (galib) no need to use in constructor
