                ...
                <div class="col-md-10">
                    <div class="form-group">
                        <div class="custom-file">
                            <input type="file" class="custom-file-input required {{ $errors->has('photo') ? ' is-invalid' : '' }}" id="image" name="image" accept="image/jpeg, image/png" onchange="previewImage(this, 'show_photo', '1', '')">
