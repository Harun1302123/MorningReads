                            ...
                            <div class="col-md-6 col-12">
                                <div class="col-xs-12">
                                    ...
                                    <div class="col-md-12  col-12 row">
                                        ...
                                        <div class="col-7">
                                            : <span style="font-size: 16px">{{ $association->user_email }}</span>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 text-center">
                                        <button type="button"
                                                ...
                                                class="fa fa-check"></i> {!! trans('Dashboard::messages.approve') !!}
                                        </button>
                                        <button type="button"
                                                value="{{ \App\Libraries\Encryption::encodeId($association->id) }}"
                                                onclick="approveAndRejectCompanyAssoc(this,'reject')"
                                                class="btn btn-danger"><i
                                                class="fa fa-times"></i> {!! trans('Dashboard::messages.cancel') !!}
                                        </button>
                                    </div>
                                </div>
                            </div>
