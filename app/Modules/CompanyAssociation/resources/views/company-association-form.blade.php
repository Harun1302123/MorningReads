                    ...
                    <div class="panel panel-primary setup-content" id="step-2">
                        <div class="panel-body">
                            ...
                            <div class="form-group col-md-12 row" id="user_type_section" style="display:none;">
                                <input type="hidden" id="org_company_id" name="org_company_id">
                                {!! Form::label('user_type', 'ব্যবহারকারীর ধরণ:', ['class' => 'col-md-3 required-star']) !!}
                                <div class="col-md-9">
                                    <label class="radio-inline">{!! Form::radio('user_type','company','', ['class'=>'user_type required','id'=>'user_type_company']) !!}
                                        প্রতিষ্ঠানের ব্যবহারকারী</label>
                                    <label class="radio-inline">{!! Form::radio('user_type', 'bscic','', ['class'=>'user_type required','id'=>'user_type_bscic']) !!}
                                        কর্তৃপক্ষ ব্যবহারকারী</label>
                                    {!! $errors->first('user_type','<span class="help-block">:message</span>') !!}
                                </div>
                            </div>
                            <div class="form-group col-md-12 form-input row" id="company_user_section" style="display: none;">
                            ...
                            <div class="form-group col-md-12 form-input row" id="bscic_user_section" style="display: none;">
