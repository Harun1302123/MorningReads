...
class OsspidLog
{
    ...
    {
        $this->osspid_log_grant_type = config('osspid.osspid_log_grant_type');
        $this->osspid_log_my_client_id = config('osspid.osspid_log_my_client_id');
        $this->osspid_log_my_secret_key = config('osspid.osspid_log_my_secret_key');
        $this->osspid_log_token_url = config('osspid.osspid_log_token_url');
        $this->osspid_log_data_url = config('osspid.osspid_log_data_url');
        $this->osspid_log_content_type = config('osspid.osspid_log_content_type');
    }
        ...
        try{
            $data = [
                "osspidServiceRequest" => [
                    ...
                    "requestData" => [
                        "clientId" => config('osspid.osspid_client_id'),
                        "secretKey" => config('osspid.osspid_client_secret_key'),
