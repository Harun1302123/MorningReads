...
{{-- 
    ob#code@start - Harun  
     Try to keep clean blade template, pass data from controller
    ob#code@end - Harun
--}}
<?php
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 hidden training_assign_div">
                            <div class="form-group row has-feedback {{ $errors->has('training_assign') ? 'needs-validation' : '' }}">
                                {!! Form::label('training_assign', 'Select Training Desk:', ['class' => 'col-md-4 required-star']) !!}
                                <div class="col-sm-8">
                                    <div class="input-group ">
                                        {!! Form::select('training_assign', [1 => 'Coordinator', 2 => 'Director'], null, $attributes = array('class'=>'form-control', 'placeholder' => 'Select Training Desk', 'id'=>"training_assign")) !!}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-md-8">
                                            ...
                                            <label class="btn btn-primary btn-file">
                                                ...
                                                Browse<input type="file" class="custom-file-input input-sm {{ empty($user_pic) ? 'required' : '' }}" name="user_pic" id="user_pic" onchange="imageUploadWithCroppingAndDetect(this, 'user_pic_preview', 'user_pic_base64')" size="300x300">
                                            </label>
                                        </div>
                                    </div>
                                </div>
...
@section('footer-script')
    ...
    <script>
        $(document).on('change', '#user_type', function (){
            var type = $(this).val();
            if(type == '4x404'){
                $('.training_assign_div').removeClass('hidden');
            }else{
                $('.training_assign_div').addClass('hidden');
            }
        })
    </script>
