                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-3 text-center">
                            <br/>
                            <img src="{{ url('users/profile-pic/'.$user->user_pic) }}" onerror="this.src=`{{asset('/assets/images/default_profile.jpg')}}`" alt="Profile picture" class="profile-user-img img-responsive img-circle"/>
                        </div>
                    </div>
                </div><!-- /.box -->
