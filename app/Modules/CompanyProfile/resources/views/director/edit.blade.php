...
{!! Form::open(array('url' => '/client/company-profile/update-director-session','method' => 'post', 'class' => 'form-horizontal smart-form','id'=>'directorForm',
...
<div class="modal-body">
    ...
    <div class="successMsg alert alert-success alert-dismissible hidden">
        <button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button></div>
    <input type="hidden" name="id" value="{{ Encryption::encodeId($id) }}">
        ...
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="form-group margin-bottom">
                <div class="{{$errors->has('nid_designation') ? 'has-error': ''}}">
                    ...
                    <div class="col-md-9">
                        {!! Form::text('nid_designation',$director_list['l_director_designation'], ['class'=>'form-control required bnEng', 'placeholder' => trans("CompanyProfile::messages.write_designation"), 'id'=>'nid_designation']) !!}
        ...
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="form-group margin-bottom">
                <div class="{{$errors->has('tin_designation') ? 'has-error': ''}}">
                    ...
                    <div class="col-md-9">
                        {!! Form::text('tin_designation',$director_list['l_director_designation'], ['class'=>'form-control required bnEng', 'placeholder' => trans("CompanyProfile::messages.write_designation"), 'id'=>'tin_designation']) !!}
        ...
        <div class="col-md-10 col-md-offset-1">
            ...
            <div class="form-group margin-bottom">
                ...
                <div class="col-md-9 {{$errors->has('passport_designation') ? 'has-error': ''}}">
                    {!! Form::text('passport_designation',$director_list['l_director_designation'], ['class'=>'form-control required bnEng', 'placeholder' => trans("CompanyProfile::messages.write_designation")]) !!}
...
<script>
    ...
    function uploadDocument(targets, id, vField, isRequired) {
        ...
        try {
            var action = "<?php echo e(url('/client/company-profile/upload-document')); ?>";
