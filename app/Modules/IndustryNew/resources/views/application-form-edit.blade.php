        ...
        <fieldset>
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-md-8 {{ $errors->has('auth_person_mobile') ? 'has-error' : '' }}">
                                    {!! Form::text('auth_person_mobile', $appInfo->auth_person_mobile, ['placeholder' => trans('CompanyProfile::messages.write_mobile_no'), 'class' => 'form-control input-md input_ban onlyNumber', 'id' => 'auth_person_mobile', 'onkeyup' => 'mobile_no_validation(this.id)']) !!}
            ...
            <div class="card card-magenta border border-magenta">
                ...
                <div class="card-body" style="padding: 15px 25px;">
                    ...
                    <div class="checkbox">
                        <label>
                            {!! Form::checkbox('accept_terms', 1, $appInfo->accept_terms ?? '', ['id' => 'accept_terms', 'class' => 'required']) !!}
