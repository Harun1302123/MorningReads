{{-- ob#code@start - (galib) styles can come from common css--}}
<link rel="stylesheet"
                ...
                <fieldset>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div
                                            class="col-md-8 {{ $errors->has('company_name_bangla') ? 'has-error' : '' }}">
                                            {!! Form::text('company_name_bangla', isset($companyInfo->org_nm_bn) ? $companyInfo->org_nm_bn : '', [
                                                'placeholder' => trans('CompanyProfile::messages.write_company_name_bangla'),
                                                'class' => 'form-control input-md bnEng',
                                                'id' => 'company_name_bangla',
                                                'readonly' => $companyUserType != 'Employee' ? true : false,
                                            ]) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div
                                            class="col-md-8 {{ $errors->has('company_name_english') ? 'has-error' : '' }}">
                                            {!! Form::text('company_name_english', isset($companyInfo->org_nm) ? $companyInfo->org_nm : '', [
                                                'placeholder' => trans('CompanyProfile::messages.write_company_name_english'),
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('project_name') ? 'has-error' : '' }}">
                                            {!! Form::text('project_name', '', [
                                                'placeholder' => trans('CompanyProfile::messages.project_name'),
                                                'class' => 'form-control input-md',
                                                'id' => 'project_name',
                                            ]) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('reg_type_id') ? 'has-error' : '' }}">
                                            {!! Form::select('reg_type_id', $regType, isset($companyInfo->regist_type) ? $companyInfo->regist_type : '', [
                                                'class' => 'form-control input-md',
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('company_type') ? 'has-error' : '' }}">
                                            {!! Form::select('company_type_id', $companyType, isset($companyInfo->org_type) ? $companyInfo->org_type : '', [
                                                'class' => 'form-control input-md',
                                                'placeholder' => trans('CompanyProfile::messages.select'),
                                                'id' => 'company_type_id',
                                                'disabled' => $companyUserType != 'Employee' ? true : false,
                                            ]) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div
                                            class="col-md-8 {{ $errors->has('business_category_id') ? 'has-error' : '' }}">
                                            {!! Form::select(
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('company_type') ? 'has-error' : '' }}">
                                            {!! Form::select(
                                                'investment_type_id',
                                                $investmentType,
                                                isset($companyInfo->invest_type) ? $companyInfo->invest_type : '',
                                                [
                                                    'class' => 'form-control input-md',
                                                    'placeholder' => trans('CompanyProfile::messages.select'),
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div
                                            class="col-md-8 {{ $errors->has('investing_country_id') ? 'has-error' : '' }}">
                                            {!! Form::select('investing_country_id[]', $country, isset($investing_country) ? $investing_country : '', [
                                                'class' => 'form-control input-md investing_country_id',
                                                'placeholder' => trans('CompanyProfile::messages.select'),
                                                'id' => 'investing_country_id',
                                            ]) !!}
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div
                                            class="col-md-8 {{ $errors->has('total_investment') ? 'has-error' : '' }}">
                                            {!! Form::text('total_investment', isset($companyInfo->investment_limit) ? $companyInfo->investment_limit : '', [
                                                'placeholder' => trans('CompanyProfile::messages.write_total_investment'),
                                                'class' => 'form-control input-md input_ban onlyNumber',
                                                'id' => 'total_investment',
                                            ]) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        {!! Form::label('industrial_category_id', trans('CompanyProfile::messages.industrial_class'), [
                                            'class' => 'col-md-3 ',
                                        ]) !!} <div class="col-md-1 "><i class="fa fa-cog"
                                                data-toggle="modal" data-target="#feeModal"
                                                title="শিল্পের শ্রেণীকরণ সহকারে সরকারি ফি এর বিষয়ে জানতে ক্লিক করুন"></i>
                                        </div>
                                        <div
                                            ...
                                            {!! Form::select(
                                                ...
                                                $industrialCategory,
                                                isset($companyInfo->ind_category_id) ? $companyInfo->ind_category_id : '',
                                                [
                                                    'class' => 'form-control input-md',
                                                    'readonly',
                                                    'placeholder' => trans('CompanyProfile::messages.select'),
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div
                                            class="col-md-8 {{ $errors->has('industrial_sector_id') ? 'has-error' : '' }}">
                                            {!! Form::select(
                                                'industrial_sector_id',
                                                $industrialSector,
                                                isset($companyInfo->ins_sector_id) ? $companyInfo->ins_sector_id : '',
                                                [
                                                    'class' => 'form-control input-md',
                                                    'placeholder' => trans('CompanyProfile::messages.select'),
                                                    'id' => 'industrial_sector_id',
                                                ],
                                            ) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div
                                            ...
                                            {!! Form::select(
                                                'industrial_sub_sector_id',
                                                $industrialSubSector,
                                                isset($companyInfo->ins_sub_sector_id) ? $companyInfo->ins_sub_sector_id : '',
                                                [
                                                    'class' => 'form-control input-md',
                                                    'placeholder' => trans('CompanyProfile::messages.select'),
                                                    'id' => 'industrial_sub_sector_id',
                                                ],
                                            ) !!}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('pref_reg_office') ? 'has-error' : '' }}">
                                            {!! Form::select(
                                                'pref_reg_office',
                                                $regOffice,
                                                isset($companyInfo->bscic_office_id) ? $companyInfo->bscic_office_id : '',
                                                [
                                                    'class' => 'form-control input-md',
                                                    'placeholder' => trans('CompanyProfile::messages.select'),
                                                    'id' => 'pref_reg_office',
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-10 {{ $errors->has('company_main_works') ? 'has-error' : '' }}"
                                            ...
                                            {!! Form::text('company_main_works', isset($companyInfo->main_activities) ? $companyInfo->main_activities : '', [
                                                'placeholder' => trans('CompanyProfile::messages.company_main_works'),
                                                'class' => 'form-control input-md',
                                                'id' => 'company_main_works',
                                            ]) !!}
                    ...
                    <div class="card card-magenta border border-magenta">
                        ...
                        <div class="card-body table-responsive" style="padding: 15px 25px;">
                            <table id="annualProductionTable" class="table table-bordered" cellspacing="0"
                                width="100%">
                                <thead>
                                ...
                                <tbody>
                                    <tr id="annualProductionRow" data-number="1">
                                        <td>
                                            {!! Form::text('apc_service_name[0]', '', [
                                                'class' => 'form-control input-md text-center',
                                                'placeholder' => trans('CompanyProfile::messages.write_name'),
                                                'id' => 'apc_service_name',
                                            ]) !!}
                                        </td>
                                        <td>
                                            {!! Form::text('apc_quantity[0]', '', [
                                                'class' => 'form-control input-md text-center onlyNumber input_ban tabInput',
                                                'placeholder' => trans('CompanyProfile::messages.write_amount'),
                                                'id' => 'apc_quantity',
                                            ]) !!}
                                        </td>
                                        <td>
                                            {!! Form::select('apc_unit[0]', $apc_unit, null, [
                                        ...
                                        <td>
                                            {!! Form::text('apc_amount_bdt[0]', '', [
                                                'class' => 'form-control input-md text-center onlyNumber input_ban apc_amount_bdt tabInput',
                                                'onkeyup' => "calculateMachineryTotal('apc_amount_bdt', 'apc_price_total')",
                                                'placeholder' => trans('CompanyProfile::messages.price_lak_taka'),
                                                'id' => 'apc_amount_bdt',
                                            ]) !!}
                                        </td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        {!! Form::text('apc_price_total', '', [
                                            'class' => 'form-control input-md text-center onlyNumber input_ban',
                                            'readonly',
                                            'placeholder' => trans('CompanyProfile::messages.price_taka'),
                                            'id' => 'apc_price_total',
                                        ]) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('local_sales') ? 'has-error' : '' }}">
                                            {!! Form::text('local_sales', '', [
                                                'placeholder' => '0%',
                                                'class' => 'form-control input-md onlyNumber input_ban',
                                                'id' => 'local_sales_per',
                                            ]) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('foreign') ? 'has-error' : '' }}">
                                            {!! Form::text('foreign_sales', '', [
                                                'placeholder' => '0%',
                                                'class' => 'form-control input-md onlyNumber input_ban',
                                                'id' => 'foreign_sales_per',
                                            ]) !!}
                            ...
                            <div class="table-responsive">
                                <table id="" class="table table-bordered  table-striped" cellspacing="0"
                                    ...
                                    <tbody id="manpower">
                                        ...
                                        <tr>
                                            <td>
                                                {!! Form::text('local_male', '', [
                                                    'class' => 'form-control input-md text-center onlyNumber input_ban tabInput_sm',
                                                    'placeholder' => trans('CompanyProfile::messages.n_number'),
                                                    'id' => 'local_male',
                                                ]) !!}
                                                {!! $errors->first('local_male', '<span class="help-block">:message</span>') !!}
                                            </td>
                                            <td>
                                                {!! Form::text('local_female', '', [
                                                    'class' => 'form-control input-md text-center onlyNumber input_ban tabInput_sm',
                                                    'placeholder' => trans('CompanyProfile::messages.n_number'),
                                                    'id' => 'local_female',
                                                ]) !!}
                                            ...
                                            <td>
                                                {!! Form::text('local_total', '', [
                                                    'class' => 'form-control input-md text-center input_ban tabInput_sm',
                                                    'readonly',
                                                    'placeholder' => trans('CompanyProfile::messages.total'),
                                                    'id' => 'local_total',
                                                ]) !!}
                                                {!! $errors->first('local_total', '<span class="help-block">:message</span>') !!}
                                            </td>
                                            <td>
                                                {!! Form::text('foreign_male', '', [
                                                    'class' => 'form-control input-md text-center onlyNumber input_ban tabInput_sm',
                                                    'placeholder' => trans('CompanyProfile::messages.n_number'),
                                                    'id' => 'foreign_male',
                                                ]) !!}
                                            ...
                                            <td>
                                                {!! Form::text('manpower_total', '', [
                                                    'class' => 'form-control input-md text-center input_ban tabInput_sm',
                                                    'readonly',
                                                    'placeholder' => trans('CompanyProfile::messages.grand_total'),
                                                    'id' => 'mp_total',
                                                ]) !!}
                                                {!! $errors->first('manpower_total', '<span class="help-block">:message</span>') !!}
                                            </td>
                                            <td>
                                                {!! Form::text('manpower_local_ratio', '', [
                                                    'class' => 'form-control input-md text-center input_ban tabInput_sm',
                                                    'readonly',
                                                    'placeholder' => trans('CompanyProfile::messages.local_rate'),
                                                    'id' => 'mp_ratio_local',
                                                ]) !!}
                                                {!! $errors->first('manpower_local_ratio', '<span class="help-block">:message</span>') !!}
                                            </td>
                                            <td>
                                                {!! Form::text('manpower_foreign_ratio', '', [
                                                    'class' => 'form-control input-md text-center input_ban tabInput_sm',
                                                    'readonly',
                                                    'placeholder' => trans('CompanyProfile::messages.foreign_rate'),
                                                    'id' => 'mp_ratio_foreign',
                                                ]) !!}
                                            ...
                                            <tr>
                                                <td>
                                                    <span class="helpTextCom"
                                                        id="">{{ $value->name_bn }}</span>
                                                    {!! Form::hidden('utility_id[]', $value->id, []) !!}
                                                </td>
                                                <td>
                                                    <div class="text-center">
                                                        <label class="radio control-label" for=""
                                                            style="margin-right: 15px">
                                                            {!! Form::radio("services_availability[$key]", 1, false, ['class' => 'radio', 'id' => '']) !!}
                                                            {!! trans('CompanyProfile::messages.yes') !!}
                                                        </label>

                                                        <label class="radio control-label" for=""
                                                            style="margin-left: 15px">
                                                            {!! Form::radio("services_availability[$key]", 0, false, ['class' => 'radio', 'id' => '']) !!}
                                                ...
                                                <td>
                                                    <table style="width:100%;">
                                                        <tr>
                                                            <td>
                                                                {!! Form::text('utility_distance[]', null, [
                                                                    'class' => 'form-control input-md onlyNumber input_ban text-center',
                                                                    'id' => 'utility_distance',
                                                            ...
                                                            <td>
                                                                {!! Form::select(
                                                                    'distance_unit[]',
                                                                    ['Meter' => trans('IndustryNew::messages.Meter'), 'Kilometer' => trans('IndustryNew::messages.Kilometer')],
                                                                    '',
                                                                    [
                                                                        'id' => 'utility_distance_unit',
                                                                        'class' => 'form-control input-md',
                                                                        'placeholder' => trans('CompanyProfile::messages.select'),
                                                                    ],
                                                                ) !!}
                                ...
                                <table id="" class="table table-bordered">
                                    <thead>
                                        <tr class="section_heading2">
                                            <th class="text-center required-star" colspan="4">
                                                {!! trans('CompanyProfile::messages.investment_source') !!}
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr style="background: #F9F9F9">
                                            ...
                                            <td>
                                                {!! Form::text('ceo_taka_invest', '', [
                                                    'class' => 'form-control input-md text-center onlyNumber input_ban tabInput',
                                                    'placeholder' => '0',
                                                    'id' => 'ceo_taka_invest',
                                                    'onkeyup' => 'calculateInvSourceTaka()',
                                                ]) !!}
                                                {!! $errors->first('ceo_taka_invest', '<span class="help-block">:message</span>') !!}
                                            </td>
                                            <td>
                                                {!! Form::text('ceo_dollar_invest', '', [
                                                    'class' => 'form-control input-md text-center onlyNumber input_ban tabInput',
                                                    'placeholder' => '0',
                                                    'id' => 'ceo_dollar_invest',
                                                    'onkeyup' => 'calculateInvSourceDollar()',
                                                ]) !!}
                                                {!! $errors->first('ceo_dollar_invest', '<span class="help-block">:message</span>') !!}
                                            </td>
                                            <td>
                                                {!! Form::text('ceo_loan_org_country', '', [
                                                    'class' => 'form-control input-md text-center',
                                                    'placeholder' => trans('CompanyProfile::messages.loan_org_country'),
                                                    'id' => 'ceo_loan_country',
                                                ]) !!}
                                        ...
                                        <tr style="background: #FFFFFF">
                                            ...
                                            <td>
                                                {!! Form::text('local_loan_dollar', '', [
                                                    'class' => 'form-control input-md text-center onlyNumber input_ban',
                                                    'placeholder' => '0',
                                                    'id' => 'local_loan_dollar',
                                                    'onkeyup' => 'calculateInvSourceDollar()',
                                                ]) !!}
                                                {!! $errors->first('local_loan_dollar', '<span class="help-block">:message</span>') !!}
                                            </td>
                                            <td>
                                                {!! Form::text('local_loan_org_country', '', [
                                                    'class' => 'form-control input-md text-center',
                                                    'placeholder' => trans('CompanyProfile::messages.loan_org_country'),
                                                    'id' => 'local_loan_country',
                                                ]) !!}
                                        ...
                                        <tr style="background: #F9F9F9">
                                            ...
                                            <td>
                                                {!! Form::text('foreign_loan_taka', '', [
                                                    'class' => 'form-control input-md text-center onlyNumber input_ban',
                                                    'placeholder' => '0',
                                                    'id' => 'foreign_loan_taka',
                                                    'onkeyup' => 'calculateInvSourceTaka()',
                                                ]) !!}
                                                {!! $errors->first('foreign_loan_taka', '<span class="help-block">:message</span>') !!}
                                            </td>
                                            <td>
                                                {!! Form::text('foreign_loan_dollar', '', [
                                                    'class' => 'form-control input-md text-center onlyNumber input_ban',
                                                    'placeholder' => '0',
                                                    'id' => 'foreign_loan_dollar',
                                                    'onkeyup' => 'calculateInvSourceDollar()',
                                                ]) !!}
                                                {!! $errors->first('foreign_loan_dollar', '<span class="help-block">:message</span>') !!}
                                            </td>
                                            <td>
                                                {!! Form::text('foreign_loan_org_country', '', [
                                                    'class' => 'form-control input-md text-center',
                                                    'placeholder' => trans('CompanyProfile::messages.loan_org_country'),
                                                    'id' => 'foreign_loan_country',
                                                ]) !!}
                                        ...
                                        <tr style="background: #FFFFFF">
                                            ...
                                            <td>
                                                {!! Form::text('total_inv_taka', '', [
                                                    'class' => 'form-control input-md input_ban',
                                                    'readonly',
                                                    'placeholder' => '0',
                                                    'id' => 'total_inv_taka',
                                                ]) !!}
                ...
                <fieldset>
                    ...
                    <div class="card-body" style="padding: 15px 25px;">
                        <div class="card card-magenta border border-magenta">
                            ...
                            <div class="card-body table-responsive" style="padding: 15px 25px;">
                                <table id="localRawMaterialTable" class="table table-bordered" cellspacing="0"
                                    width="100%">
                                    <thead>
                                        <tr class="section_heading2">
                                    ...
                                    <tbody>
                                        <tr id="localRawMaterialRow" data-number="1">
                                            <td>
                                                {!! Form::text('local_raw_material_name[0]', '', [
                                                    'class' => 'form-control input-md text-center',
                                                    'placeholder' => trans('CompanyProfile::messages.write_name'),
                                                    'id' => 'local_raw_material_name',
                                                ]) !!}
                                            </td>
                                            <td>
                                                {!! Form::text('local_raw_material_quantity[0]', '', [
                                                    'class' => 'form-control input-md text-center onlyNumber input_ban tabInput',
                                                    'placeholder' => trans('CompanyProfile::messages.write_amount'),
                                                    'id' => 'local_raw_material_quantity',
                                                ]) !!}
                                            </td>
                                            <td>
                                                {!! Form::select('local_raw_material_unit[0]', $apc_unit, null, [
                                                    'class' => 'form-control input-md tabInput',
                                                    'placeholder' => trans('CompanyProfile::messages.select'),
                                                    'id' => 'local_raw_material_unit',
                                                ]) !!}
                                            </td>
                                            <td>
                                                {!! Form::text('local_raw_material_amount_bdt[0]', '', [
                                                    'class' => 'form-control input-md text-center onlyNumber input_ban local_raw_material_amount_bdt tabInput',
                                                    'onkeyup' => "calculateMachineryTotal('local_raw_material_amount_bdt', 'local_raw_price_total')",
                                                    'placeholder' => trans('CompanyProfile::messages.price_lak_taka'),
                                                    'id' => 'local_raw_material_amount_bdt',
                                                ]) !!}
                                            </td>
                                            <td class="text-center">
                                                <a class="btn btn-sm btn-info addTableRows" title="Add more"
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            {!! Form::text('local_raw_price_total', '', [
                                                'class' => 'form-control input-md text-center onlyNumber input_ban',
                                                'readonly',
                                                'placeholder' => trans('CompanyProfile::messages.price_taka'),
                                                'id' => 'local_raw_price_total',
                                            ]) !!}
                        ...
                        <table id="" class="table table-bordered" cellspacing="0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        {!! Form::text('local_raw_material_number', '', [
                                            'class' => 'form-control input-md text-center onlyNumber input_ban tabInput',
                                            'placeholder' => trans('CompanyProfile::messages.n_number'),
                                            'id' => 'local_raw_material_number',
                                            'onkeyup' => 'calculateRawMaterialNumber()',
                                        ]) !!}
                                        {!! $errors->first('local_raw_material_number', '<span class="help-block">:message</span>') !!}
                                    </td>
                                    <td>
                                        {!! Form::text('local_raw_material_price', '', [
                                            'class' => 'form-control input-md text-center onlyNumber input_ban tabInput',
                                            'placeholder' => trans('CompanyProfile::messages.price_taka'),
                                            'id' => 'local_raw_material_price',
                                            'onkeyup' => 'calculateRawMaterialPrice()',
                                        ]) !!}
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {!! Form::text('import_raw_material_number', '', [
                                            'class' => 'form-control input-md text-center onlyNumber input_ban tabInput',
                                            'placeholder' => trans('CompanyProfile::messages.n_number'),
                                            'id' => 'import_raw_material_number',
                                            'onkeyup' => 'calculateRawMaterialNumber()',
                                        ]) !!}
                                        {!! $errors->first('import_raw_material_number', '<span class="help-block">:message</span>') !!}
                                    </td>
                                    <td>
                                        {!! Form::text('import_raw_material_price', '', [
                                            'class' => 'form-control input-md text-center onlyNumber input_ban tabInput',
                                            'placeholder' => trans('CompanyProfile::messages.price_taka'),
                                            'id' => 'import_raw_material_price',
                                            'onkeyup' => 'calculateRawMaterialPrice()',
                                        ]) !!}
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {!! Form::text('raw_material_total_number', '', [
                                            'class' => 'form-control input-md text-center onlyNumber input_ban tabInput',
                                            'readonly',
                                            'placeholder' => trans('CompanyProfile::messages.n_number'),
                                            'id' => 'raw_material_total_number',
                                        ]) !!}
                                        {!! $errors->first('raw_material_total_number', '<span class="help-block">:message</span>') !!}
                                    </td>
                                    <td>
                                        {!! Form::text('raw_material_total_price', '', [
                                            'class' => 'form-control input-md text-center onlyNumber input_ban tabInput',
                                            'readonly',
                                            'placeholder' => trans('CompanyProfile::messages.taka'),
                                            'id' => 'raw_material_total_price',
                                        ]) !!}
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('auth_person_nm') ? 'has-error' : '' }}">
                                            {!! Form::text('auth_person_nm', Auth::user()->user_first_name, [
                                                'placeholder' => trans('CompanyProfile::messages.write_name'),
                                                'class' => 'form-control input-md',
                                                'id' => 'auth_person_nm',
                                            ]) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div
                                            class="col-md-8 {{ $errors->has('auth_person_desig') ? 'has-error' : '' }}">
                                            {!! Form::text('auth_person_desig', Auth::user()->designation, [
                                                'placeholder' => trans('CompanyProfile::messages.write_designation'),
                                                'class' => 'form-control input-md',
                                                'id' => 'auth_person_desig',
                                            ]) !!}
                                ...
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10 {{ $errors->has('auth_person_address') ? 'has-error' : '' }}"
                                            style="width: 79.5%; float: right">
                                            {!! Form::text('auth_person_address', '', [
                                                'placeholder' => trans('CompanyProfile::messages.write_address'),
                                                'class' => 'form-control input-md',
                                                'id' => 'auth_person_address',
                                            ]) !!}
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div
                                            class="col-md-8 {{ $errors->has('auth_person_mobile') ? 'has-error' : '' }}">
                                            {!! Form::text('auth_person_mobile', Auth::user()->user_mobile, [
                                                'placeholder' => trans('CompanyProfile::messages.write_mobile_no'),
                                                'class' => 'form-control input-md input_ban onlyNumber',
                                                'id' => 'auth_person_mobile',
                                                'onkeyup' => 'mobile_no_validation(this.id)',
                                            ]) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div
                                            class="col-md-8 {{ $errors->has('auth_person_email') ? 'has-error' : '' }}">
                                            {!! Form::text('auth_person_email', Auth::user()->user_email, [
                                                'placeholder' => trans('CompanyProfile::messages.write_email'),
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div
                                            class="col-md-8 {{ $errors->has('authorization_letter') ? 'has-error' : '' }}">
                                            {!! Form::file('authorization_letter', [
                                                'class' => 'form-control input-md',
                                            ...
                                            <a target="_blank" href="{{ asset('uploads/pdf-upload/sample/SamplAuthLetter.pdf') }}">স্যাম্পল ফাইল</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
...
{{--ob#code@start - (galib) remove commented code--}}
                    {{-- <div class="card">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            {!! Form::text('sfp_contact_address', Auth::user()->road_no, ['class' => 'form-control input-md required']) !!}
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-1 "><i class="fa fa-cog" data-toggle="modal"
                                                data-target="#feeModal" title="সার্ভিস ফি এর বিষয়ে জানতে ক্লিক করুন"></i>
                                        </div>
                                        <div class="col-md-8">
                                            {!! Form::text('sfp_pay_amount', '', ['class' => 'form-control input-md', 'readonly', 'id' => 'sfp_pay_amount']) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            {!! Form::text('sfp_vat_on_pay_amount', '', ['class' => 'form-control input-md', 'readonly']) !!}
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            {!! Form::text('sfp_total_amount', '', ['class' => 'form-control input-md', 'readonly']) !!}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="alert alert-danger" role="alert">
                                            <strong>ভ্যাট / ট্যাক্স </strong> এবং <strong>লেনদেনের চার্জ </strong> আনুমানিক
                                            পরিমাণ, সোনালী ব্যাংকের পেমেন্ট সিস্টেমের উপর ভিত্তি করে এগুলি পরিবর্তিত হতে পারে
                                            এবং অর্থ প্রদানের পরে তা এখানে দৃশ্যমান হবে।
                                        </div>
                                    </div>
                                </div>
                            </div>
