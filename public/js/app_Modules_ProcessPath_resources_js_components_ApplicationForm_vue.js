"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["app_Modules_ProcessPath_resources_js_components_ApplicationForm_vue"],{
  ...
  computed: {
    setAppComponent: function setAppComponent() {
      ...
      return (0,vue__WEBPACK_IMPORTED_MODULE_0__.defineAsyncComponent)(function () {
        return __webpack_require__("./app/Modules lazy recursive ^\\.\\/.*\\.vue$")("./".concat(_this.module_name, "/resources/js/components/").concat(_this.appComponentName, ".vue"));
      });
    }
  },
