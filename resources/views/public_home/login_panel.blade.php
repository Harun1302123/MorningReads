                ...
                <div class="row">
                    <div class="col-md-12 otp_step_1" id="otp_step_1">
                        <div class="form-group row otp_receiver">
                            {!! Form::label('otp_by', 'Mobile:', array('class' => 'col-sm-3 col-form-label', 'id' => '')) !!}
                            {{-- {!! Form::label('otp_by', 'Email ID:', array('class' => 'col-sm-3 col-form-label', 'id' => '')) !!} --}}

                            <div class="col-sm-9">
                                {!! Form::text('email', '', $attributes = ['class' => 'form-control required bd_mobile', 'placeholder' => 'Enter your Number', 'id' => 'email_address']) !!}
